...
var require_google_login = __commonJS({
  "node_modules/react-google-login/dist/google-login.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module == "object" ? module.exports = t(require_react()) : typeof define == "function" && define.amd ? define(["react"], t) : typeof exports == "object" ? exports.GoogleLogin = t(require_react()) : e.GoogleLogin = t(e.react);
      ...
      return o = {}, t.m = n = [function(t2) {
        ...
        function o2(e3, t3) {
          return function(e4) {
            ...
            if (e4) {
              ...
              return n3 === "Object" && e4.constructor && (n3 = e4.constructor.name), n3 === "Map" || n3 === "Set" ? Array.from(n3) : n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3) ? r(e4, t4) : void 0;
            }
          }(e3, t3) || function() {
          ...
          return function(e4) {
            ...
            if (e4) {
              if (typeof e4 == "string")
                return a(e4, t4);
              var n3 = Object.prototype.toString.call(e4).slice(8, -1);
              return n3 === "Object" && e4.constructor && (n3 = e4.constructor.name), n3 === "Map" || n3 === "Set" ? Array.from(n3) : n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3) ? a(e4, t4) : void 0;
            }
          }(e3, t3) || function() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
          }();
          ...
          return function(e4) {
            ...
            if (e4) {
              if (typeof e4 == "string")
                return u(e4, t4);
              var n3 = Object.prototype.toString.call(e4).slice(8, -1);
              return n3 === "Object" && e4.constructor && (n3 = e4.constructor.name), n3 === "Map" || n3 === "Set" ? Array.from(n3) : n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3) ? u(e4, t4) : void 0;
            }
          }(e3, t3) || function() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
          }();
          ...
          return function(e4) {
            ...
            if (e4) {
              if (typeof e4 == "string")
                return s(e4, t4);
              var n3 = Object.prototype.toString.call(e4).slice(8, -1);
              return n3 === "Object" && e4.constructor && (n3 = e4.constructor.name), n3 === "Map" || n3 === "Set" ? Array.from(n3) : n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3) ? s(e4, t4) : void 0;
            }
          }(e3, t3) || function() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
          }();
        ...
        var m = n2(0), b = n2.n(m), h = (n2(1), function(e3) {
          ...
          function n3(e4) {
            if (e4 && e4.preventDefault(), P) {
              ...
              p2(), _ === "code" ? n4.grantOfflineAccess(o3).then(function(e5) {
                return i2(e5);
              }, function(e5) {
                return l2(e5);
          ...
          var r2 = e3.onSuccess, i2 = r2 === void 0 ? function() {
          } : r2, a2 = e3.onAutoLoadFinished, c2 = a2 === void 0 ? function() {
          } : a2, u2 = e3.onFailure, l2 = u2 === void 0 ? function() {
          } : u2, s2 = e3.onRequest, p2 = s2 === void 0 ? function() {
          } : s2, g2 = e3.onScriptLoadFailure, y2 = e3.clientId, b2 = e3.cookiePolicy, h2 = e3.loginHint, v2 = e3.hostedDomain, S2 = e3.autoLoad, j2 = e3.isSignedIn, O2 = e3.fetchBasicProfile, x = e3.redirectUri, I = e3.discoveryDocs, w = e3.uxMode, k = e3.scope, A = e3.accessType, _ = e3.responseType, E = e3.jsSrc, T = E === void 0 ? "https://apis.google.com/js/api.js" : E, L = e3.prompt, M = o2(Object(m.useState)(false), 2), P = M[0], C = M[1];
          return Object(m.useEffect)(function() {
            ...
            return f(document, "script", "google-login", T, function() {
              ...
              _ === "code" && (o3.access_type = "offline"), window.gapi.load("auth2", function() {
        ...
        function v(e3) {
          ...
          var k = { backgroundColor: v2 === "dark" ? "rgb(66, 133, 244)" : "#fff", display: "inline-flex", alignItems: "center", color: v2 === "dark" ? "#fff" : "rgba(0, 0, 0, .54)", boxShadow: "0 2px 2px 0 rgba(0, 0, 0, .24), 0 0 1px 0 rgba(0, 0, 0, .24)", padding: 0, borderRadius: 2, border: "1px solid transparent", fontSize: 14, fontWeight: "500", fontFamily: "Roboto, sans-serif" }, A = { cursor: "pointer", backgroundColor: v2 === "dark" ? "#3367D6" : "#eee", color: v2 === "dark" ? "#fff" : "rgba(0, 0, 0, .54)", opacity: 1 }, _ = w ? Object.assign({}, k, f2) : i2 ? Object.assign({}, k, A) : n3 ? Object.assign({}, k, { cursor: "pointer", opacity: 0.9 }) : k;
        ...
        if (t.r(o2), Object.defineProperty(o2, "default", { enumerable: true, value: e2 }), 2 & n2 && typeof e2 != "string")
          for (var r in e2)
